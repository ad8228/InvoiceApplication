<%--<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateInvoice.aspx.cs" Inherits="InvoiceApplication.CreateInvoice" %>
    ...
    <div id="invoiceTable">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtHours2" runat="server" Style="width: 60px"></asp:TextBox></td>A
                <td>
